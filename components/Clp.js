...
import { TapGestureHandler } from 'react-native-gesture-handler';
 ...
 export default class Comlead extends Component {
  static navigationOptions = {
    title: 'CLP Communication',
  
    headerTitleStyle :{flex:1,marginLeft:40,alignSelf:'center' ,color:'#0099cc'},
...
<View style={styles.boxtwo}>
  ...
  onPress={() => this.props.navigation.navigate('Commerce')} >
          ...
          <Text style={styles.signUpText}>PPT</Text>
          <Text style={styles.signUpText1}>Duration : 4 Days</Text>
    ...
    <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} 
        onPress={() => this.props.navigation.navigate('Science')} >
          ...
          <Text style={styles.signUpText}>Seminar </Text>
          <Text style={styles.signUpText1}>Duration : 4 Days</Text>
