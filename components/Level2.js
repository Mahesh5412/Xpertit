 ...
 <View style={styles.boxone}>
    ...
    <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} 
        onPress={() => this.props.navigation.navigate('Webdev')} >
          ...
          <Text style={styles.signUpText}>Web Development</Text>
          <Text style={styles.signUpText1}>Duration : 1 Month</Text>
...
<View style={styles.boxtwo}>
         <View style={styles.signup}>
    <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} 
  onPress={() => this.props.navigation.navigate('Appdev')} >
          
          <Text style={styles.signUpText}>App Development</Text>
          <Text style={styles.signUpText1}>Duration :1  Month</Text>
...
<View style={styles.boxthree}>
  ...
  onPress={() => this.props.navigation.navigate('Webdesign')} >
          ...
          <Text style={styles.signUpText}>Web And App Designing</Text>
          <Text style={styles.signUpText1}>Duration :1 Month</Text>
...
<View style={styles.boxthree}>
 ...
 onPress={() => this.props.navigation.navigate('Java')} >
         ...
         <Text style={styles.signUpText}>Java</Text>
          <Text style={styles.signUpText1}>Duration :1 Month</Text>
   </TouchableOpacity>
         </View>
